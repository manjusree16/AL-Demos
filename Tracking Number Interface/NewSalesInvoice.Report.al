report 50102 "New Standard Sales Invoice"
{
    ...
    dataset
    {
        dataitem(Header; "Sales Invoice Header")
        {
            ...
            column(Tracking_Url; TrackingUrl)
            {
            ...
            begin
                ...
                TrackingNumber := Header."Tracking Service Provider";
                TrackingNumber.GetTrackingURL(TrackingNumber.GenerateTrackingNumber(), TrackingUrl);
                TrackingUrl := TrackingUrl + Header."No.";
